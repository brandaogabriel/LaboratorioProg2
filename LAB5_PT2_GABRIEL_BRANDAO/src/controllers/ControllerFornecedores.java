...
/**
 * Representacao de um controlador de fornecedor, este por sua vez eh
 * responsavel por cadastrar, exibir, editar e remover fornecedores do sistema
 * SAGA
 */
public class ControllerFornecedores {
	...
	/**
	 * Representao de um mapa ordenado de fornecedores. A chave eh o nome do
	 ...
	 * @throws IllegalArgumentException Se o fornecedor ja existir a excecao eh
	 *                                  lancada
	 */
	 ...
	 * @throws IllegalArgumentException Caso o fornecedor que deseja-se exibir nao
	 *                                  exista, a excecao eh lancada
	 */
	 ...
	 * @throws IllegalArgumentException Se for tentado alteracao do nome do
	 *                                  fornecedor a excecao eh lancada visto que o
	 *                                  nome eh o identificador, dessa forma, nao
	 *                                  pode ser alterado.
	 */
	 ...
	 * @throws IllegalArgumentException Caso o parametro do metodo seja uma string
	 *                                  vazia a excecao eh lancada
	 */
	...
	/**
	 * O metodo retorna o mapa de fornecedores para manipulacao no
	 * ControllerProdutos.
	 * 
